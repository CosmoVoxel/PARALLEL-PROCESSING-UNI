...
gcc -o $BUILD_DIR/test_block $DIR/test_block_size_k5.c -lm -O3 -fopenmp
...
RESULT_FILE="$DIR/block_size_results_k5.txt"
...
echo "$best_size" > "$DIR/optimal_block_size_k5.txt"
echo "Results saved to $RESULT_FILE and optimal block size saved to optimal_block_size_k5.txt"